...
switch ($_REQUEST['exec'])
{
    case "level_input_info" :
        ...
        if ($dupli_num > 0)
		{
            ...
            $query		= "INSERT INTO member_info(mb_ipaddr, mb_name, mb_phone, mb_addr, mb_winner, mb_gubun, mb_media, mb_regdate) values('".$_SERVER['REMOTE_ADDR']."','".$level_name."','".$level_phone."','".$level_addr."','".$mb_winner."','".$gubun."','".$_SESSION['ss_media']."',now())";
